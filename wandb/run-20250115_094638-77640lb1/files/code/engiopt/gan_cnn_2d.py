...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.model = nn.Sequential(
            nn.Conv2d(1, 64, 4, 2, 1, bias=False),  # Accepts 1 channel input
...
if __name__ == "__main__":
    ...
    training_ds = th.tensor(np.load('/home/nathanielhoffman/Desktop/fake_dataset_2D/y.npy')[:100]).float().to(device)
